...
func (b *fmtBuffer) Write(p []byte) (n int, err error) {
	b.bytes = append(b.bytes, p...)
	return len(p), nil
}

func (b *fmtBuffer) WriteString(s string) (n int, err error) {
...
func (bp *fmtBuffer) WriteRune(r rune) error {
	if r < utf8.RuneSelf {
		bp.bytes = append(bp.bytes, byte(r))
		return nil
	}
...
// It returns the number of bytes written and any write error encountered.
func (p *Fmt) Printf(format string, a ...interface{}) (n int, err error) {
...
func (p *Fmt) Errorf(format string, a ...interface{}) error {
...
// Spaces are added between operands when neither is a string.
// It returns the number of bytes written and any write error encountered.
func (p *Fmt) Print(a ...interface{}) (n int, err error) {
...
// Spaces are always added between operands and a newline is appended.
// It returns the number of bytes written and any write error encountered.
func (p *Fmt) Println(a ...interface{}) (n int, err error) {
